...
XCVAR_DEF( cg_holsteredSaberBolt,				"*hip_r",	NULL,				CVAR_ARCHIVE )
XCVAR_DEF( cg_holsteredSaberBolt2,				"*hip_l",	NULL,				CVAR_ARCHIVE )
XCVAR_DEF( cg_holsteredSaberPos,				"0 0 -9.25",	NULL,			CVAR_ARCHIVE )
